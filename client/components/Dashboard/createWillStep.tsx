        ...
        <motion.div variants={variants} initial="hidden" animate="show" exit="exit">
            <motion.div variants={fadeUp} initial="hidden" animate="show">
                ...
                <motion.div variants={child} style={{ textAlign: 'center', marginBottom: 30 }}>
                    ...
                    <h2 style={{
                        margin: '0 0 8px', fontSize: 22, fontWeight: 500,
                    ...
                    <p style={{
                        ...
                        color: 'var(--text-secondary)', maxWidth: 390,
                        marginInline: 'auto', letterSpacing: '-0.02em',
                    }}>
                            ...
                            return (
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        background: active ? 'rgba(0,0,0,0.04)' : 'var(--surface)',
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        display: 'flex', gap: 12, alignItems: 'center', marginBottom: 26,
                    }}
                >
                    <div style={{
                    ...
                    <div>
                        ...
                        <div style={{
                            ...
                            {/* Updates live as user picks a different interval */}
                ...
                <motion.button
                    ...
                    style={{
                        ...
                        border: 'none',
                        background: isLoading ? 'rgba(0,0,0,0.12)' : 'var(--primary)',
